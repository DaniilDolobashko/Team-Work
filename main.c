...
void listOfPhones(Product* inventoryOfPhones, int count) {
...
void listOfChargers(Product* inventoryOfChargers, int countChargers) {
    ...
    for (int i = 0; i < countChargers; i++) {
        printf("ID: %d, Назва: %s %s, Довжина: %.0f GB, Ціна: %.2f грн\n", inventoryOfChargers[i].id, inventoryOfChargers[i].brand, inventoryOfChargers[i].name, inventoryOfChargers[i].leigth, inventoryOfChargers[i].price);
    }
}
...
int main() {
    ...
    strcpy(inventoryOfPhones[0].brand, "Samsung");
    ...
    inventoryOfPhones[0].memory = 256;
    inventoryOfPhones[3].price = 400.0;

    inventoryOfPhones[4].id = 5;
    strcpy(inventoryOfPhones[0].brand, "Xiaomi"); // [0] !!!
    ...
    strcpy(inventoryOfChargers[0].name, "Швидкий шнур"); // РОЗЙОМ
    inventoryOfChargers[0].leigth = 1;
    inventoryOfPhones[0].price = 50.0;
                    ...
                    case 1:
                        do {
                            ...
                            switch (choiceOfCategory) {
                                case 1:
                                    listOfPhones(inventoryOfPhones, count);
                                    break;
                                case 2:
